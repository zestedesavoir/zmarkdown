...
var checkFileType = function checkFileType(name, data) {
  ...
  if (!type.mime || type.mime === 'application/xml') {
    ...
    throw new Error('Detected mime of local file \'' + name + '\' is not an image/ type');
  }
};
...
var checkAndCopy = function () {
  ...
  return function checkAndCopy(_x2, _x3) {
...
function plugin() {
  ...
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      maxFileSize = _ref2$maxFileSize === undefined ? 1000000 : _ref2$maxFileSize,
      _ref2$dirSizeLimit = _ref2.dirSizeLimit,
      dirSizeLimit = _ref2$dirSizeLimit === undefined ? 10000000 : _ref2$dirSizeLimit,
  ...
  var initDownload = function initDownload(url) {
    return new Promise(function (resolve, reject) {
      ...
      var options = Object.assign({}, parsedUrl, { timeout: httpRequestTimeout });
  ...
  var doDownloadTasks = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tasks) {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 13:
              ...
              if (totalSize + fileSize >= dirSizeLimit) {
                e = new Error('Cannot download ' + task.url + ' because destination ' + 'directory reached size limit');
  ...
  return function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(tree, vfile) {
      var _this2 = this;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              visit(tree, 'image', function () {
                var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(node) {
                    ...
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        ...
                        case 25:
                          ...
                          localCopyTasks.push({ node: node, url: url, destination: destination, localSourcePath: localPath });
                        ...
                        case 30:
                          ...
                          downloadTasks.push({ node: node, url: url, destination: destination });
              ...
              groupTasksByUrl = function groupTasksByUrl(tasks) {
                ...
                return Array.from(map.values()).map(function (taskGroup) {
                  return Object.assign({}, taskGroup[0], { nodes: taskGroup.map(function (t) {
                      return t.node;
                    }) });
                });
              };
      ...
      }, _callee4, this, [[15, 108], [23, 51, 55, 63], [30, 34, 38, 46], [39,, 41, 45], [56,, 58, 62], [66, 94, 98, 106], [73, 77, 81, 89], [82,, 84, 88], [99,, 101, 105]]);
    }));
