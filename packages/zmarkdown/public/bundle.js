...
"use strict";module.exports=function(e,i,r){var t={type:"link",url:e.data.hProperties.src,children:[{type:"text",value:e.data.hProperties.src}]},l={type:"image",url:e.data.thumbnail};if("figure"!==r.type){var c={type:"figure",children:[l,{type:"figcaption",children:[t]}]};r.children.splice(i,1,c)}else r.children.splice(i,1,l),r.children[r.children.length-1].children.push(t)};
