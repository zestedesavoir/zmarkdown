...
"use strict";module.exports=function(e,r,l){var i={type:"link",url:e.data.hProperties.src,children:[{type:"text",value:e.data.hProperties.src}]};console.error(e),console.error(e.data),console.error(e.data.thumbnail);var t={type:"image",url:e.data.thumbnail};if(console.log(t),"figure"!==l.type){var c={type:"figure",children:[t,{type:"figcaption",children:[i]}]};l.children.splice(r,1,c)}else l.children.splice(r,1,t),l.children[l.children.length-1].children.push(i)};
...
"use strict";var _typeof2="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_slicedToArray=function(){function e(e,t){var r=[],n=!0,o=!1,a=void 0;try{for(var i,f=e[Symbol.iterator]();!(n=(i=f.next()).done)&&(r.push(i.value),!t||r.length!==t);n=!0);}catch(e){o=!0,a=e}finally{try{!n&&f.return&&f.return()}finally{if(o)throw a}}return r}return function(t,r){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_typeof="function"==typeof Symbol&&"symbol"===_typeof2(Symbol.iterator)?function(e){return void 0===e?"undefined":_typeof2(e)}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":void 0===e?"undefined":_typeof2(e)},URL=require("url"),urlParse=URL.parse;module.exports=function(e){function t(t){var r=urlParse(t).hostname;return e[r]}function r(e,t){var r=t;if(e.replace&&e.replace.length&&e.replace.forEach(function(e){var t=_slicedToArray(e,2),n=t[0],o=t[1];n&&o&&(r=r.replace(n,o))}),e.removeFileName){var n=urlParse(r);n.pathname=n.pathname.substring(0,n.pathname.lastIndexOf("/")),r=URL.format(n)}return e.append&&(r+=e.append),e.removeAfter&&-1!==r.indexOf(e.removeAfter)&&(r=r.substring(0,r.indexOf(e.removeAfter))),r}function n(e,t){var r="default image";if(e.thumbnail&&e.thumbnail.format){var n=e.thumbnail;r=n.format,Object.keys(n).filter(function(e){return"format"!==e}).forEach(function(e){var o=new RegExp("{"+e+"}","g"),a=new RegExp(n[e]).exec(t);a.length&&(r=r.replace(o,a[1]))})}return r}function o(e,t){return e.indexOf("!(http",t)}function a(e,o,a){for(var i="",f="",u=0;u<o.length&&")"!==o[u-1];u++)i+=o[u],"!"!==o[u]&&"("!==o[u]&&")"!==o[u]&&(f+=o[u]);if(a)return!0;var l=t(f);if(!l||!0===l.disabled||l.match&&l.match instanceof RegExp&&!l.match.test(f)){if(!i.startsWith("!(http"))return;e(i)({type:"text",value:i})}else{var c=r(l,f),p=n(l,c);e(i)({type:"iframe",data:{hName:l.tag,hProperties:{src:c,width:l.width,height:l.height,allowfullscreen:!0,frameborder:"0"},thumbnail:p}})}}if("object"!==(void 0===e?"undefined":_typeof(e))||!Object.keys(e).length)throw new Error("remark-iframes needs to be passed a configuration object as option");a.locator=o;var i=this.Parser,f=i.prototype.inlineTokenizers,u=i.prototype.inlineMethods;f.iframes=a,u.splice(u.indexOf("autoLink"),0,"iframes")};
