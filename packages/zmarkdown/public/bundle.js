...
},{"./one":20}],9:[function(require,module,exports){
...
},{"../all":8}],10:[function(require,module,exports){
...
},{"../all":8}],11:[function(require,module,exports){
...
},{"../all":8}],12:[function(require,module,exports){
...
},{"has":4}],13:[function(require,module,exports){
"use strict";function figure(n,e,i,r){var t=e.children[0].type,l=has(n,"figure")&&has(n.figure,t)&&n.figure[t]||has(defaultMacros,t)&&defaultMacros[t],a="";if(e.children.length&&(a=e.children.filter(function(n){return"figcaption"===n.type}).map(function(e){return all(n,e)}).join("")),e.caption=a,!l)return e.children[0].caption=a,one(n,e.children[0],0,e);e.children=e.children.filter(function(n){return"figcaption"!==n.type}),1===e.children.length&&(e.children=e.children[0].children);var u=has(makeExtra,t)?makeExtra[t](e):void 0;return l((all(n,e)||e.value||"").trim(),a,u)}var all=require("../all"),one=require("../one"),has=require("has");module.exports=figure;var defaultMacros={blockquote:function(n){return"\\begin{Quotation}{"+(arguments.length>1&&void 0!==arguments[1]?arguments[1]:"Anonymous")+"}\n"+n+"\n\\end{Quotation}\n\n"},code:function(n,e,i){var r="["+e+"]";return i.lines&&(r+="["+i.lines+"]"),"\\begin{codeBlock}"+r+"{"+i.language+"}\n"+n+"\n\\end{codeBlock}\n\n"},table:function(n){return n},image:function(n,e,i){return"\\begin{center}\n    \\includegraphics"+(i.width?"["+i.width+"]":"")+"{"+i.url+"}\n\\captionof{"+e+"}\n\\end{center}"}},makeExtra={blockquote:function(n){},code:function(n){var e={language:n.lang.split(" ")[0]};if(n.lang.includes(" ")){var i=n.lang.split(" ")[1];i&&(e.lines=i.replace("hl_lines=","").trim())}return e},image:function(n){return n.witdth="\\linewidth",n}};

},{"../all":8,"../one":20,"has":4}],14:[function(require,module,exports){
"use strict";function overridenTableCell(e,r){var a=clone(e);a.tableCell=void 0;var l=baseCell(a,r).trim().replace(/\n/g," \\par ");return r.data.hProperties.rowspan>1?l="\\multirow{"+r.data.hProperties.rowspan+"}{*}{"+l+"}":r.data.hProperties.colspan>1&&(l="\\multicolumn{"+r.data.hProperties.colspan+"}{|c|}{"+l+"}"),l}function overridenHeaderParse(e){var r=e.map(function(e){return e.split("&").length}),a=r.sort()[0];return("|p{\\linewidth / "+a+"}").repeat(a)+"|"}function gridTable(e,r){var a=clone(e);return a.break=function(){return" \\par"},a.tableCell=overridenTableCell,a.headerParse=overridenHeaderParse,baseTable(a,r)}var baseCell=require("../types/tableCell"),baseTable=require("../types/table"),clone=require("clone");module.exports=gridTable;

},{"../types/table":44,"../types/tableCell":45,"clone":1}],15:[function(require,module,exports){
"use strict";function kbd(e,l){return"\\keys{"+all(e,l)+"}"}var all=require("../all");module.exports=kbd;

},{"../all":8}],16:[function(require,module,exports){
"use strict";function sub(r,t,u,e){return"\\textsubscript{"+all(r,t)+"}"}var all=require("../all");module.exports=sub;

},{"../all":8}],17:[function(require,module,exports){
"use strict";function sup(r,e,t,u){return"\\textsuperscript{"+all(r,e)+"}"}var all=require("../all");module.exports=sup;

},{"../all":8}],18:[function(require,module,exports){
...
},{"has":4,"xtend":7}],19:[function(require,module,exports){
"use strict";function toLaTeX(e,r,t){return preprocess(r,t),one(r,e,void 0,void 0,t)}function stringify(e){function r(e){return toLaTeX(e,t,e)}var t=xtend(e,this.data("settings"));this.Compiler=r}var xtend=require("xtend"),one=require("./one"),preprocess=require("./pre-visitors");module.exports=stringify;

},{"./one":20,"./pre-visitors":23,"xtend":7}],20:[function(require,module,exports){
...
},{"./all":8,"./types/blockquote":25,"./types/break":26,"./types/code":27,"./types/comment":28,"./types/definition":29,"./types/delete":30,"./types/emphasis":31,"./types/footnote":32,"./types/footnoteDefinition":33,"./types/footnoteReference":34,"./types/heading":35,"./types/image":36,"./types/inlinecode":37,"./types/link":38,"./types/linkReference":39,"./types/list":40,"./types/listItem":41,"./types/paragraph":42,"./types/strong":43,"./types/table":44,"./types/tableCell":45,"./types/tableHeader":46,"./types/tableRow":47,"./types/text":48,"./types/thematic-break":49,"has":4,"xtend":7}],21:[function(require,module,exports){
...
},{"unist-util-visit":6}],22:[function(require,module,exports){
...
"use strict";function preVisit(e,i){var r={tableCell:[codePlugin(e,i).codeInTableVisitor],definition:[referencePlugin(e).definitionVisitor],imageReference:[referencePlugin(e).imageReferenceVisitor],heading:[headingPlugin(e)]},n=xtend(r,e.preprocessors||{});Object.keys(n).forEach(function(e){Array.isArray(n[e])&&n[e].forEach(function(r){return visit(i,e,r)})})}var xtend=require("xtend"),visit=require("unist-util-visit"),referencePlugin=require("./referenceVisitor"),codePlugin=require("./codeVisitor"),headingPlugin=require("./headingVisitor");module.exports=preVisit;

},{"./codeVisitor":21,"./headingVisitor":22,"./referenceVisitor":24,"unist-util-visit":6,"xtend":7}],24:[function(require,module,exports){
...
},{"../all":8}],26:[function(require,module,exports){
...
},{"../all":8}],33:[function(require,module,exports){
...
},{"../all":8}],34:[function(require,module,exports){
...
},{"../all":8}],36:[function(require,module,exports){
...
},{"../escaper":18}],38:[function(require,module,exports){
...
},{"../all":8,"../escaper":18,"has":4}],39:[function(require,module,exports){
...
},{"../all":8}],40:[function(require,module,exports){
...
},{"../all":8,"has":4}],41:[function(require,module,exports){
...
},{"../one":20}],48:[function(require,module,exports){
...
},{"../all":50,"has":4}],52:[function(require,module,exports){
"use strict";function encode(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=xtend(defaultEscapes,t),r=toExpression(Object.keys(n));return e=e.replace(r,function(e,t,r){return one(e,r.charAt(t+1),n)})}function one(e,t,n){return has(n,e)?n[e]:e}function toExpression(e){var t=e.map(escapeRegExp).join("|");return new RegExp("["+t+"]","g")}function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var has=require("has"),xtend=require("xtend");module.exports=encode,encode.escape=escape;var defaultEscapes={"#":"\\#",$:"\\$","%":"\\%","&":"\\&","\\":"\\textbackslash{}","^":"\\textasciicircum{}",_:"\\_","{":"\\{","}":"\\}","~":"\\textasciitilde{}"};

},{"has":4,"xtend":7}],53:[function(require,module,exports){
"use strict";function one(e,r,t,n,s){var i=has(e,"override")?e.override:{},a=xtend(handlers,i),l=r&&r.type;if(!l)throw new Error("Expected node, not `"+r+"`");if(!has(a,l))throw new Error("Cannot compile unknown node `"+l+"`");return a[l](e,r,t,n,s)}var has=require("has"),xtend=require("xtend");module.exports=one;var handlers={};handlers.root=require("./all"),handlers.heading=require("./types/heading"),handlers.paragraph=require("./types/paragraph"),handlers.comment=require("./types/comment"),handlers.text=require("./types/text"),handlers.link=require("./types/link"),handlers.list=require("./types/list"),handlers.listItem=require("./types/listItem"),handlers.break=require("./types/break"),handlers.code=require("./types/code"),handlers.strong=require("./types/strong"),handlers.emphasis=require("./types/emphasis"),handlers.delete=require("./types/delete"),handlers.inlineCode=require("./types/inlinecode"),handlers.blockquote=require("./types/blockquote"),handlers.tableCell=require("./types/tableCell"),handlers.tableRow=require("./types/tableRow"),handlers.table=require("./types/table"),handlers.thematicBreak=require("./types/thematic-break"),handlers.footnote=require("./types/footnote"),handlers.footnoteDefinition=require("./types/footnoteDefinition"),handlers.footnoteReference=require("./types/footnoteReference"),handlers.linkReference=require("./types/linkReference"),handlers.definition=require("./types/definition"),handlers.tableHeader=require("./types/tableHeader"),handlers.image=require("./types/image");

},{"./all":50,"./types/blockquote":54,"./types/break":55,"./types/code":56,"./types/comment":57,"./types/definition":58,"./types/delete":59,"./types/emphasis":60,"./types/footnote":61,"./types/footnoteDefinition":62,"./types/footnoteReference":63,"./types/heading":64,"./types/image":65,"./types/inlinecode":66,"./types/link":67,"./types/linkReference":68,"./types/list":69,"./types/listItem":70,"./types/paragraph":71,"./types/strong":72,"./types/table":73,"./types/tableCell":74,"./types/tableHeader":75,"./types/tableRow":76,"./types/text":77,"./types/thematic-break":78,"has":4,"xtend":7}],54:[function(require,module,exports){
"use strict";function blockquote(t,o){return(t.blockquote||defaultMacro)(all(t,o).trim())}var all=require("../all");module.exports=blockquote;var defaultMacro=function(t){return"\\begin{Quotation}\n"+t+"\n\\end{Quotation}\n\n"};

},{"../all":50}],55:[function(require,module,exports){
"use strict";function br(r,e){return(r.break?r.break:defaultMacro)(e)}module.exports=br;var defaultMacro=function(){return" \\\\\n"};
...
},{"../all":50}],59:[function(require,module,exports){
"use strict";function deleteNode(e,l,t,r){return"\\sout{"+all(e,l)+"}"}var all=require("../all");module.exports=deleteNode;

},{"../all":50}],60:[function(require,module,exports){
"use strict";function emphasis(e,t,l,r){return"\\textit{"+all(e,t)+"}"}var all=require("../all");module.exports=emphasis;

},{"../all":50}],61:[function(require,module,exports){
"use strict";function notes(t,o,e,r){var n=t.footnote||defaultMacro,a=!!o.inHeading;return n(all(t,o),a)}var all=require("../all");module.exports=notes;var defaultMacro=function(t,o){return o?"\\protect\\footnote{"+t+"}":"\\footnote{"+t+"}"};

},{"../all":50}],62:[function(require,module,exports){
"use strict";function notes(t,e){return(t.footnoteDefinition||defaultMacro)(e.identifier,all(t,e).trim())}var all=require("../all");module.exports=notes;var defaultMacro=function(t,e){return"\\footnote{\\label{"+t+"}"+e+"}\n"};

},{"../all":50}],63:[function(require,module,exports){
"use strict";function notes(e,t){return(e.footnoteReference||defaultMacro)(t.identifier)}module.exports=notes;var defaultMacro=function(e){return"\\ref{"+e+"}"};

},{}],64:[function(require,module,exports){
"use strict";function heading(n,t){var r=t.depth,e=all(n,t),u=n.heading||defaultHeadings,a=u[t.depth];if("function"!=typeof a)throw new Error("Cannot compile heading of depth "+r+": not a function");return a(e)}var all=require("../all");module.exports=heading;var defaultHeadings=[function(n){return"\\part{"+n+"}\n"},function(n){return"\\chapter{"+n+"}\n"},function(n){return"\\section{"+n+"}\n"},function(n){return"\\subsection{"+n+"}\n"},function(n){return"\\subsubsection{"+n+"}\n"},function(n){return"\\paragraph{"+n+"}\n"},function(n){return"\\subparagaph{"+n+"}\n"}];

},{"../all":50}],65:[function(require,module,exports){
"use strict";function image(e,i,n,a){var r=e.image?e.image:defaultMacro;return"paragraph"===a.type&&a.children.length-1&&(r=e.inlineImage?e.inlineImage:defaultInline),r(i)}module.exports=image;var defaultInline=function(e){return"\\inlineImage{"+e.url+"}"},defaultMacro=function(e){return"\\includeGraphics"+(e.width?"[width="+e.width+"]":"")+"{"+e.url+"}"};

},{}],66:[function(require,module,exports){
"use strict";function inlineCode(e,t){return"\\texttt{"+escape(t.value)+"}"}module.exports=inlineCode;var escape=require("../escaper");

},{"../escaper":52}],67:[function(require,module,exports){
"use strict";function link(r,e){if(!e.url)return"";var a=r.link||{},l=has(a,"macro")?a.macro:defaultMacro,t=has(a,"prefix")?a.prefix:"",u=escape(e.url.startsWith("/")?t+e.url:e.url);return l(all(r,e),u,e.title)}var has=require("has"),all=require("../all"),escape=require("../escaper");module.exports=link;var defaultMacro=function(r,e,a){return"\\externalLink{"+r+"}{"+e+"}"};

},{"../all":50,"../escaper":52,"has":4}],68:[function(require,module,exports){
"use strict";function linkReference(e,r){var n=e.linkReference?e.linkReference:defaultMacro,l=all(e,r);return n(r.identifier,l)}var all=require("../all");module.exports=linkReference;var defaultMacro=function(e,r){return r+"\\ref{"+e+"}"};

},{"../all":50}],69:[function(require,module,exports){
"use strict";function list(e,r){return(has(e,"list")?e.list:defaultMacro)(all(e,r),r.ordered)}var all=require("../all"),has=require("has");module.exports=list;var defaultMacro=function(e,r){return r?"\\begin{enumerate}\n"+e+"\\end{enumerate}\n":"\\begin{itemize}\n"+e+"\\end{itemize}\n"};

},{"../all":50,"has":4}],70:[function(require,module,exports){
"use strict";function listItem(t,e){return(has(t,"listItem")?t.listItem:defaultMacro)(all(t,e).trim())}module.exports=listItem;var all=require("../all"),has=require("has"),defaultMacro=function(t){return"\\item "+t+"\n"};

},{"../all":50,"has":4}],71:[function(require,module,exports){
"use strict";function paragraph(r,a){return all(r,a).trim()+"\n\n"}var all=require("../all");module.exports=paragraph;

},{"../all":50}],72:[function(require,module,exports){
"use strict";function strong(r,t,e,l){return"\\textbf{"+all(r,t)+"}"}var all=require("../all");module.exports=strong;

},{"../all":50}],73:[function(require,module,exports){
"use strict";function table(e,n){return(e.table||defaultMacro)(e,n)}function cmp(e,n){return e<n?1:e>n?-1:0}var one=require("../one");module.exports=table;var defaultHeaderParse=function(e){var n=e.map(function(e){return e.split("&").length}),r=n.sort(cmp)[0],t="|";return t+="c|".repeat(r)},defaultMacro=function(e,n){var r=e.headerParse?e.headerParse:defaultHeaderParse,t=n.children.map(function(r,t){return one(e,r,t,n)}),a=t.join(""),u=r(t),o="";return n.caption&&(o="\n\\tableCaption{"+n.caption+"}\n"),"\\begin{longtabu}{"+u+"} \\hline\n"+a+o+"\\end{longtabu}\n\n"};

},{"../one":53}],74:[function(require,module,exports){
"use strict";function tableCell(l,e){return(l.tableCell||defaultMacro)(l,e)}var all=require("../all");module.exports=tableCell;var defaultMacro=function(l,e){return all(l,e)};

},{"../all":50}],75:[function(require,module,exports){
"use strict";var all=require("../all");module.exports=function(e,l){return(e.tableHeader?e.tableHeader:all)(e,l)};

},{"../all":50}],76:[function(require,module,exports){
"use strict";function tableRow(e,n){return(e.tableRow||defaultMacro)(e,n)}var one=require("../one");module.exports=tableRow;var defaultMacro=function(e,n){var r=[];return n.children.map(function(o,t){return r.push(one(e,o,t,n))}),r.join(" & ")+" \\\\ \\hline\n"};

},{"../one":53}],77:[function(require,module,exports){
"use strict";function text(e,t,r,a){var s=t.value;return isLiteral(a)?s:escaper(s,e.escapes)}function isLiteral(e){return e&&("script"===e.tagName||"style"===e.tagName)}var escaper=require("../escaper");module.exports=text;

},{"../escaper":52}],78:[function(require,module,exports){
"use strict";function thematicBreak(t,e,r,a){return(t.thematicBreak||"\\horizontalLine")+"\n\n"}module.exports=thematicBreak;
...
},{"unist-util-visit":6}],80:[function(require,module,exports){
...
},{"unist-util-visit":6}],81:[function(require,module,exports){
...
},{"unist-util-visit":6}],82:[function(require,module,exports){
...
},{"clone":1,"unist-util-visit":6,"xtend":7}],84:[function(require,module,exports){
...
},{"unist-util-visit":6}],89:[function(require,module,exports){
...
},{"unist-util-visit":6}],90:[function(require,module,exports){
...
},{"url":332}],92:[function(require,module,exports){
...
},{"is-whitespace-character":5}],93:[function(require,module,exports){
...
},{"unist-util-visit":6}],94:[function(require,module,exports){
...
},{"./db":95}],97:[function(require,module,exports){
...
},{"./db":97}],99:[function(require,module,exports){
arguments[4][95][0].apply(exports,arguments)
},{"dup":95}],100:[function(require,module,exports){
"use strict";var db=require("./db");module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=r.locale;if(!Object.keys(db).includes(t))return e;var n=db[t],i=/ !(\s|$)/gim,u=function(e,r){return n+"!"+r};return e.replace(i,u)};

},{"./db":99}],101:[function(require,module,exports){
...
},{"./db":101}],103:[function(require,module,exports){
arguments[4][95][0].apply(exports,arguments)
},{"dup":95}],104:[function(require,module,exports){
"use strict";var db=require("./db");module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=r.locale;if(!Object.keys(db).includes(t))return e;var n=db[t],i=/ %(\s|$)/gim,u=function(e,r){return n+"%"+r};return e.replace(i,u)};

},{"./db":103}],105:[function(require,module,exports){
arguments[4][95][0].apply(exports,arguments)
...
},{"./db":105}],107:[function(require,module,exports){
arguments[4][95][0].apply(exports,arguments)
},{"dup":95}],108:[function(require,module,exports){
"use strict";var db=require("./db");module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=r.locale;if(!Object.keys(db).includes(t))return e;var n=db[t],i=/ \?(\s|$)/gim,u=function(e,r){return n+"?"+r};return e.replace(i,u)};

},{"./db":107}],109:[function(require,module,exports){
arguments[4][95][0].apply(exports,arguments)
},{"dup":95}],110:[function(require,module,exports){
"use strict";var db=require("./db");module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=r.locale;if(!Object.keys(db).includes(t))return e;var n=db[t],i=/ ;(\s|$)/gim,u=function(e,r){return n+";"+r};return e.replace(i,u)};

},{"./db":109}],111:[function(require,module,exports){
...
},{"typographic-apostrophes":313,"typographic-apostrophes-for-possessive-plurals":312,"typographic-colon":96,"typographic-copyright":314,"typographic-ellipses":315,"typographic-em-dash":98,"typographic-em-dashes":316,"typographic-en-dashes":317,"typographic-exclamation-mark":100,"typographic-guillemets":102,"typographic-percent":104,"typographic-permille":106,"typographic-question-mark":108,"typographic-registered-trademark":318,"typographic-semicolon":110,"typographic-single-spaces":319,"typographic-trademark":320}],112:[function(require,module,exports){
"use strict";var fs=require("fs"),unified=require("unified"),inspect=require("unist-util-inspect"),remarkParse=require("remark-parse"),remarkAbbr=require("remark-abbr"),remarkAlign=require("remark-align"),remarkCaptions=require("remark-captions"),remarkComments=require("remark-comments"),remarkCustomBlocks=require("remark-custom-blocks"),remarkEmoticons=require("remark-emoticons"),remarkEscapeEscaped=require("remark-escape-escaped"),remarkGridTables=require("remark-grid-tables"),remarkHeadingShifter=require("remark-heading-shift"),remarkIframes=require("remark-iframes"),remarkKbd=require("remark-kbd"),remarkMath=require("remark-math"),remarkNumberedFootnotes=require("remark-numbered-footnotes"),remarkSubSuper=require("remark-sub-super"),remarkTextr=require("./remark-textr"),remarkTrailingSpaceHeading=require("remark-heading-trailing-spaces"),remark2rehype=require("remark-rehype"),rehypeKatex=require("rehype-katex"),rehypeFootnotesTitles=require("rehype-footnotes-title"),rehypeHTMLBlocks=require("rehype-html-blocks"),rehypeStringify=require("rehype-stringify"),rebberStringify=require("rebber"),defaultConfig=require("./config"),rebberConfig={override:{emoticon:require("rebber/dist/custom-types/emoticon"),figure:require("rebber/dist/custom-types/figure"),sub:require("rebber/dist/custom-types/sub"),sup:require("rebber/dist/custom-types/sup"),kbd:require("rebber/dist/custom-types/kbd"),CenterAligned:require("rebber/dist/custom-types/align"),RightAligned:require("rebber/dist/custom-types/align"),informationCustomBlock:require("rebber/dist/custom-types/customBlocks"),secretCustomBlock:require("rebber/dist/custom-types/customBlocks"),errorCustomBlock:require("rebber/dist/custom-types/customBlocks"),warningCustomBlock:require("rebber/dist/custom-types/customBlocks"),questionCustomBlock:require("rebber/dist/custom-types/customBlocks"),abbr:require("rebber/dist/custom-types/abbr"),gridTable:require("rebber/dist/custom-types/gridTable"),math:require("rebber/src/custom-types/math"),inlineMath:require("rebber/src/custom-types/math")},emoticons:defaultConfig.emoticons,link:{prefix:"http://zestedesavoir.com"}};Object.assign(rebberConfig.override,{eCustomBlock:function(r,e){return e.type="errorCustomBlock",rebberConfig.override.errorCustomBlock(r,e)},erreurCustomBlock:function(r,e){return e.type="errorCustomBlock",rebberConfig.override.errorCustomBlock(r,e)},iCustomBlock:function(r,e){return e.type="informationCustomBlock",rebberConfig.override.informationCustomBlock(r,e)},qCustomBlock:function(r,e){return e.type="questionCustomBlock",rebberConfig.override.questionCustomBlock(r,e)},sCustomBlock:function(r,e){return e.type="secretCustomBlock",rebberConfig.override.secretCustomBlock(r,e)},aCustomBlock:function(r,e){return e.type="warningCustomBlock",rebberConfig.override.warningCustomBlock(r,e)},attentionCustomBlock:function(r,e){return e.type="warningCustomBlock",rebberConfig.override.warningCustomBlock(r,e)}});var fromFile=function(r){return fs.readFileSync(r)},zmdParser=function(r){var e=unified().use(remarkParse,r.reParse);return r.isTest||(e=e.use(remarkTextr,r.textr)),e=e.use(remarkAbbr).use(remarkAlign,r.alignBlocks).use(remarkCaptions,r.captions).use(remarkComments).use(remarkCustomBlocks,r.customBlocks).use(remarkEmoticons,r.emoticons).use(remarkEscapeEscaped,r.escapeEscaped).use(remarkGridTables).use(remarkHeadingShifter,r.headingShifter).use(remarkIframes,r.iframes).use(remarkMath,r.math).use(remarkKbd).use(remarkNumberedFootnotes).use(remarkSubSuper).use(remarkTrailingSpaceHeading)},rehypeProcessor=function(r){return zmdParser(r).use(remark2rehype,r.remark2rehype).use(rehypeHTMLBlocks).use(rehypeFootnotesTitles,r.footnotesTitles).use(rehypeKatex,r.katex).use(rehypeStringify)},rebberProcessor=function(r){return zmdParser(r).use(rebberStringify,rebberConfig)},mdastParser=function(r){return function(e){return zmdParser(r).parse(e)}},rehypeParser=function(r){return function(e){return rehypeProcessor(r).parse(e)}},rehypeCompiler=function(r){return function(e){return rehypeProcessor(r).runSync(e)}},rehypeStringifier=function(r){return function(e){return rehypeProcessor(r).stringify(e)}},rebberParser=function(r){return function(e){return rebberProcessor(r).parse(e)}},rebberCompiler=function(r){return function(e){return rebberProcessor(r).runSync(e)}},rebberStringifier=function(r){return function(e){return rebberProcessor(r).stringify(e)}},stringToHTML=function(r){return function(e){return rehypeStringifier(r)(rehypeCompiler(r)(rehypeParser(r)(e)))}},stringToLaTeX=function(r){return function(e){return rebberStringifier(r)(rebberCompiler(r)(rebberParser(r)(e)))}},fileToHTML=function(r){return function(e){return stringToHTML(r)(fromFile(e))}},fileToLaTeX=function(r){return function(e){return stringToLaTeX(r)(fromFile(e))}};module.exports=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:defaultConfig,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"html";return{config:r,inspect:inspect,parse:mdastParser(r),transform:"html"===e?rehypeCompiler(r):rebberCompiler(r),renderFile:"html"===e?fileToHTML(r):fileToLaTeX(r),renderString:"html"===e?stringToHTML(r):stringToLaTeX(r)}};

},{"./config":111,"./remark-textr":342,"fs":115,"rebber":19,"rebber/dist/custom-types/abbr":9,"rebber/dist/custom-types/align":10,"rebber/dist/custom-types/customBlocks":11,"rebber/dist/custom-types/emoticon":12,"rebber/dist/custom-types/figure":13,"rebber/dist/custom-types/gridTable":14,"rebber/dist/custom-types/kbd":15,"rebber/dist/custom-types/sub":16,"rebber/dist/custom-types/sup":17,"rebber/src/custom-types/math":51,"rehype-footnotes-title":79,"rehype-html-blocks":80,"rehype-katex":231,"rehype-stringify":247,"remark-abbr":81,"remark-align":82,"remark-captions":83,"remark-comments":84,"remark-custom-blocks":85,"remark-emoticons":86,"remark-escape-escaped":87,"remark-grid-tables":88,"remark-heading-shift":89,"remark-heading-trailing-spaces":90,"remark-iframes":91,"remark-kbd":92,"remark-math":249,"remark-numbered-footnotes":93,"remark-parse":251,"remark-rehype":300,"remark-sub-super":94,"unified":322,"unist-util-inspect":326}],113:[function(require,module,exports){
...
},{"base64-js":114,"ieee754":152}],117:[function(require,module,exports){
...
},{"trim":310}],125:[function(require,module,exports){
...
},{"repeat-string":301}],126:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],127:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"./implementation":126,"dup":3}],128:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"dup":4,"function-bind":127}],129:[function(require,module,exports){
...
},{"camelcase":117,"has":128,"hastscript":150,"property-information":226,"vfile-location":337}],130:[function(require,module,exports){
...
},{"./one":146}],134:[function(require,module,exports){
...
},{"./all":133,"ccount":118,"comma-separated-tokens":124,"kebab-case":187,"property-information":226,"space-separated-tokens":303,"stringify-entities":306,"xtend":341}],137:[function(require,module,exports){
...
},{"./omission":139,"./one":146,"html-void-elements":151}],138:[function(require,module,exports){
...
},{"./omission":140,"./util/siblings":144,"./util/white-space-left":145,"hast-util-is-element":130,"unist-util-is":327}],139:[function(require,module,exports){
"use strict";exports.opening=require("./opening"),exports.closing=require("./closing");

},{"./closing":138,"./opening":141}],140:[function(require,module,exports){
...
},{"./closing":138,"./omission":140,"./util/first":142,"./util/place":143,"./util/siblings":144,"./util/white-space-left":145,"hast-util-is-element":130,"unist-util-is":327}],142:[function(require,module,exports){
"use strict";function first(r,t){return after(r,-1,t)}var after=require("./siblings").after;module.exports=first;

},{"./siblings":144}],143:[function(require,module,exports){
...
},{"hast-util-whitespace":149}],145:[function(require,module,exports){
...
},{"hast-util-whitespace":149,"unist-util-is":327}],146:[function(require,module,exports){
...
},{"./all":133,"./comment":134,"./doctype":135,"./element":136,"./raw":147,"./text":148}],147:[function(require,module,exports){
"use strict";function raw(e,t){return e.dangerous?t.value:text(e,t)}var text=require("./text");module.exports=raw;

},{"./text":148}],148:[function(require,module,exports){
...
},{"stringify-entities":306,"xtend":341}],149:[function(require,module,exports){
...
},{"camelcase":117,"comma-separated-tokens":124,"hast-util-parse-selector":131,"property-information":226,"space-separated-tokens":303}],151:[function(require,module,exports){
module.exports=[
  "area",
  "base",
  "basefont",
...
},{"is-alphabetical":154,"is-decimal":157}],156:[function(require,module,exports){
...
},{"./src/ParseError":167,"./src/Settings":169,"./src/buildTree":174,"./src/parseTree":183,"./src/utils":186}],164:[function(require,module,exports){
...
},{"./ParseError":167,"match-at":189}],165:[function(require,module,exports){
...
},{"./Lexer":164}],166:[function(require,module,exports){
...
},{"./MacroExpander":165,"./ParseError":167,"./environments":177,"./functions":180,"./parseData":182,"./symbols":184,"./unicodeRegexes":185,"./utils":186}],169:[function(require,module,exports){
...
},{"./fontMetrics.js":178}],171:[function(require,module,exports){
...
},{"./domTree":176,"./fontMetrics":178,"./symbols":184,"./utils":186}],172:[function(require,module,exports){
...
},{"./ParseError":167,"./Style":170,"./buildCommon":171,"./delimiter":175,"./domTree":176,"./fontMetrics":178,"./utils":186}],173:[function(require,module,exports){
...
},{"./ParseError":167,"./buildCommon":171,"./fontMetrics":178,"./mathMLTree":181,"./symbols":184,"./utils":186}],174:[function(require,module,exports){
...
},{"./Options":166,"./Settings":169,"./Style":170,"./buildCommon":171,"./buildHTML":172,"./buildMathML":173}],175:[function(require,module,exports){
...
},{"./ParseError":167,"./Style":170,"./buildCommon":171,"./fontMetrics":178,"./symbols":184,"./utils":186}],176:[function(require,module,exports){
...
},{"./unicodeRegexes":185,"./utils":186}],177:[function(require,module,exports){
...
},{"./ParseError":167,"./Style":170,"./parseData":182}],178:[function(require,module,exports){
...
},{"./Style":170,"./fontMetricsData":179,"./unicodeRegexes":185}],179:[function(require,module,exports){
...
},{"./ParseError":167,"./parseData":182,"./utils":186}],181:[function(require,module,exports){
...
},{"./utils":186}],182:[function(require,module,exports){
...
},{"./Parser":168}],184:[function(require,module,exports){
...
},{"unist-util-visit":331}],191:[function(require,module,exports){
"use strict";module.exports=require("./lib/index.js");

},{"./lib/index.js":218}],192:[function(require,module,exports){
...
},{"./one":219,"trim":310}],193:[function(require,module,exports){
...
},{"./all":192,"unist-builder":324}],194:[function(require,module,exports){
...
},{"./handlers/list":211,"./handlers/thematic-break":217,"./wrap":220}],195:[function(require,module,exports){
...
},{"unist-builder":324}],201:[function(require,module,exports){
...
},{"unist-builder":324}],204:[function(require,module,exports){
...
},{"../failsafe":193,"normalize-uri":221}],205:[function(require,module,exports){
...
},{"normalize-uri":221}],206:[function(require,module,exports){
...
},{"./blockquote":195,"./break":196,"./code":197,"./delete":198,"./emphasis":199,"./footnote":201,"./footnote-reference":200,"./heading":202,"./html":203,"./image":205,"./image-reference":204,"./inline-code":207,"./link":209,"./link-reference":208,"./list":211,"./list-item":210,"./paragraph":212,"./root":213,"./strong":214,"./table":215,"./text":216,"./thematic-break":217}],207:[function(require,module,exports){
...
},{"collapse-white-space":123,"unist-builder":324}],208:[function(require,module,exports){
...
},{"../all":192,"../failsafe":193,"normalize-uri":221}],209:[function(require,module,exports){
...
},{"../all":192,"normalize-uri":221}],210:[function(require,module,exports){
...
},{"../all":192,"../wrap":220,"unist-builder":324}],211:[function(require,module,exports){
...
},{"../all":192,"../wrap":220,"unist-builder":324}],214:[function(require,module,exports){
"use strict";function strong(r,t){return r(t,"strong",all(r,t))}module.exports=strong;var all=require("../all");

},{"../all":192}],215:[function(require,module,exports){
...
},{"../all":192,"../wrap":220,"unist-util-position":328}],216:[function(require,module,exports){
...
},{"trim-lines":308,"unist-builder":324}],217:[function(require,module,exports){
...
},{"./footer":194,"./handlers":206,"./one":219,"mdast-util-definitions":190,"unist-builder":324,"unist-util-generated":325,"unist-util-position":328,"unist-util-visit":331,"xtend":341}],219:[function(require,module,exports){
...
},{"./all":192,"unist-builder":324}],220:[function(require,module,exports){
...
},{"unist-builder":324}],221:[function(require,module,exports){
...
},{"character-entities":121,"character-entities-legacy":120,"character-reference-invalid":122,"is-alphanumerical":155,"is-decimal":157,"is-hexadecimal":159}],224:[function(require,module,exports){
(function (process){
...
},{"katex":163,"rehype-parse":232,"unified":322,"unist-util-position":328,"unist-util-visit":331}],232:[function(require,module,exports){
...
},{"hast-util-from-parse5":129,"parse5/lib/parser":241,"xtend":341}],233:[function(require,module,exports){
...
},{"../tokenizer":243,"./html":235}],235:[function(require,module,exports){
...
},{"../common/html":235,"../parser/open_element_stack":242,"../tokenizer":243}],239:[function(require,module,exports){
...
},{"../common/unicode":237}],240:[function(require,module,exports){
...
},{"../common/doctype":233,"../common/foreign_content":234,"../common/html":235,"../common/merge_options":236,"../common/unicode":237,"../location_info/parser_mixin":238,"../tokenizer":243,"../tree_adapters/default":246,"./formatting_element_list":240,"./open_element_stack":242}],242:[function(require,module,exports){
...
},{"../common/html":235}],243:[function(require,module,exports){
...
},{"../common/unicode":237,"../location_info/tokenizer_mixin":239,"./named_entity_trie":244,"./preprocessor":245}],244:[function(require,module,exports){
...
},{"../common/unicode":237}],246:[function(require,module,exports){
...
},{"hast-util-to-html":132,"xtend":341}],248:[function(require,module,exports){
...
},{"trim-trailing-lines":309}],249:[function(require,module,exports){
...
},{"./block":248,"./inline":250}],250:[function(require,module,exports){
...
},{"./lib/parser.js":265,"unherit":321,"xtend":341}],252:[function(require,module,exports){
module.exports=[
  "address",
  "article",
  "aside",
...
},{"parse-entities":223}],254:[function(require,module,exports){
...
},{"./block-elements":252}],255:[function(require,module,exports){
...
},{"unist-util-remove-position":329,"xtend":341}],265:[function(require,module,exports){
...
},{"./decode":253,"./defaults":254,"./parse":264,"./set-options":266,"./tokenize/auto-link":267,"./tokenize/blockquote":268,"./tokenize/break":269,"./tokenize/code-fenced":270,"./tokenize/code-indented":271,"./tokenize/code-inline":272,"./tokenize/definition":273,"./tokenize/delete":274,"./tokenize/emphasis":275,"./tokenize/escape":276,"./tokenize/footnote-definition":277,"./tokenize/heading-atx":278,"./tokenize/heading-setext":279,"./tokenize/html-block":280,"./tokenize/html-inline":281,"./tokenize/link":282,"./tokenize/list":283,"./tokenize/newline":284,"./tokenize/paragraph":285,"./tokenize/reference":286,"./tokenize/strong":287,"./tokenize/table":288,"./tokenize/text":289,"./tokenize/thematic-break":290,"./tokenize/url":291,"./tokenize/yaml":292,"./tokenizer":293,"./unescape":294,"state-toggle":304,"vfile-location":337,"xtend":341}],266:[function(require,module,exports){
...
},{"./defaults":254,"markdown-escapes":188,"xtend":341}],267:[function(require,module,exports){
...
},{"../locate/tag":262,"parse-entities":223}],268:[function(require,module,exports){
...
},{"../util/interrupt":297,"trim":310}],269:[function(require,module,exports){
...
},{"../locate/break":255}],270:[function(require,module,exports){
...
},{"trim-trailing-lines":309}],271:[function(require,module,exports){
...
},{"repeat-string":301,"trim-trailing-lines":309}],272:[function(require,module,exports){
...
},{"../locate/code-inline":256,"is-whitespace-character":161}],273:[function(require,module,exports){
...
},{"../util/normalize":298,"is-whitespace-character":161}],274:[function(require,module,exports){
...
},{"../locate/delete":257,"is-whitespace-character":161}],275:[function(require,module,exports){
...
},{"../locate/emphasis":258,"is-whitespace-character":161,"is-word-character":162,"trim":310}],276:[function(require,module,exports){
...
},{"../locate/escape":259}],277:[function(require,module,exports){
...
},{"../util/normalize":298,"is-whitespace-character":161}],278:[function(require,module,exports){
...
},{"../util/html":296}],281:[function(require,module,exports){
...
},{"../locate/tag":262,"../util/html":296,"is-alphabetical":154}],282:[function(require,module,exports){
...
},{"../locate/link":260,"has":128,"is-whitespace-character":161}],283:[function(require,module,exports){
...
},{"../util/get-indentation":295,"../util/interrupt":297,"../util/remove-indentation":299,"is-decimal":157,"repeat-string":301,"trim":310}],284:[function(require,module,exports){
...
},{"is-whitespace-character":161}],285:[function(require,module,exports){
...
},{"../util/interrupt":297,"is-decimal":157,"trim":310,"trim-trailing-lines":309}],286:[function(require,module,exports){
...
},{"../locate/link":260,"../util/normalize":298,"is-whitespace-character":161}],287:[function(require,module,exports){
...
},{"../locate/strong":261,"is-whitespace-character":161,"trim":310}],288:[function(require,module,exports){
...
},{"is-whitespace-character":161}],289:[function(require,module,exports){
...
},{"../locate/url":263,"is-whitespace-character":161,"parse-entities":223}],292:[function(require,module,exports){
...
},{"collapse-white-space":123}],299:[function(require,module,exports){
...
},{"./get-indentation":295,"repeat-string":301,"trim":310}],300:[function(require,module,exports){
...
},{"mdast-util-to-hast":191}],301:[function(require,module,exports){
...
},{"path":224}],303:[function(require,module,exports){
...
},{"trim":310}],304:[function(require,module,exports){
...
},{"./dangerous.json":305,"character-entities-html4":119,"character-entities-legacy":120,"is-alphanumerical":155,"is-hexadecimal":159}],307:[function(require,module,exports){
...
},{"inherits":153,"xtend":341}],322:[function(require,module,exports){
...
},{"bail":113,"extend":323,"is-plain-obj":160,"trough":311,"vfile":338,"x-is-function":339,"x-is-string":340}],323:[function(require,module,exports){
...
},{"object-assign":222}],325:[function(require,module,exports){
...
},{"is-empty":158,"util":336}],327:[function(require,module,exports){
...
},{"unist-util-visit":331}],330:[function(require,module,exports){
...
},{"./util":333,"punycode":227,"querystring":230}],333:[function(require,module,exports){
...
},{"dup":153}],335:[function(require,module,exports){
...
},{"./support/isBuffer":335,"_process":225,"inherits":334}],337:[function(require,module,exports){
...
},{"_process":225,"is-buffer":156,"path":224,"replace-ext":302,"unist-util-stringify-position":330}],339:[function(require,module,exports){
...
},{"textr":307,"unist-util-visit":331}]},{},[112])(112)
});
