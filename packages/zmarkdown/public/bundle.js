...
"use strict";function align(n,e){return(n[e.type]||defaultMacros[e.type]||defaultMacros.defaultType)(all(n,e),e.type)}var all=require("../all");module.exports=align;var defaultMacros={leftAligned:function(n){return"\n\n"+n+"\n\n"},centerAligned:function(n){return"\n\\begin{center}\n"+n+"\n\\end{center}\n"},rightAligned:function(n){return"\n\\begin{flushright}\n"+n+"\n\\end{flushright}\n"},defaultType:function(n,e){return"\n\\begin{"+e+"}\n"+n+"\n\\end{"+e+"}\n"}};

},{"../all":238}],241:[function(require,module,exports){
"use strict";function customBlock(t,e){var a=t[e.type]||defaultMacros[e.type]||defaultMacros.defaultBlock,l=all(t,e).trim(),o=t.customBlocks||{},r=void 0,u=e.type.replace("CustomBlock","");return r=o.map&&o.map[u]?o.map[u]:u[0].toUpperCase()+u.substring(1),a(l,r)}var all=require("../all");module.exports=customBlock;var defaultMacros={defaultBlock:function(t,e){return"\\begin{"+e+"}\n"+t+"\n\\end{"+e+"}\n"}};
...
},{"../types/table":277,"../types/tableCell":278,"clone":10}],245:[function(require,module,exports){
...
"use strict";function one(e,r,t,n,s){var i=has(e,"override")?e.override:{},a=xtend(handlers,i),l=r&&r.type;if(!l)throw new Error("Expected node, not `"+r+"`");if(!has(a,l))throw new Error("Cannot compile unknown node `"+l+"`");return a[l](e,r,t,n,s)}var has=require("has"),xtend=require("xtend");module.exports=one;var handlers={};handlers.root=require("./all"),handlers.heading=require("./types/heading"),handlers.paragraph=require("./types/paragraph"),handlers.comment=require("./types/comment"),handlers.blockquote=require("./types/blockquote"),handlers.break=require("./types/break"),handlers.code=require("./types/code"),handlers.definition=require("./types/definition"),handlers.delete=require("./types/delete"),handlers.emphasis=require("./types/emphasis"),handlers.footnote=require("./types/footnote"),handlers.footnoteDefinition=require("./types/footnoteDefinition"),handlers.footnoteReference=require("./types/footnoteReference"),handlers.html=require("./types/html"),handlers.image=require("./types/image"),handlers.inlineCode=require("./types/inlinecode"),handlers.link=require("./types/link"),handlers.linkReference=require("./types/linkReference"),handlers.list=require("./types/list"),handlers.listItem=require("./types/listItem"),handlers.strong=require("./types/strong"),handlers.table=require("./types/table"),handlers.tableCell=require("./types/tableCell"),handlers.tableHeader=require("./types/tableHeader"),handlers.tableRow=require("./types/tableRow"),handlers.text=require("./types/text"),handlers.thematicBreak=require("./types/thematic-break");

},{"./all":238,"./types/blockquote":257,"./types/break":258,"./types/code":259,"./types/comment":260,"./types/definition":261,"./types/delete":262,"./types/emphasis":263,"./types/footnote":264,"./types/footnoteDefinition":265,"./types/footnoteReference":266,"./types/heading":267,"./types/html":268,"./types/image":269,"./types/inlinecode":270,"./types/link":271,"./types/linkReference":272,"./types/list":273,"./types/listItem":274,"./types/paragraph":275,"./types/strong":276,"./types/table":277,"./types/tableCell":278,"./types/tableHeader":279,"./types/tableRow":280,"./types/text":281,"./types/thematic-break":282,"has":17,"xtend":237}],252:[function(require,module,exports){
...
"use strict";function notes(t,e,o,r){var n=t.footnote||defaultMacro,a=!!e.inHeading;return n(e.identifier,all(t,e).trim(),a)}var all=require("../all");module.exports=notes;var defaultMacro=function(t,e,o){var r="\\footnote["+t+"]{\\label{footnote:"+t+"} "+e+"}\n";return o?r+"\\protect":r};

},{"../all":238}],265:[function(require,module,exports){
"use strict";function notes(t,e){return(t.footnoteDefinition||defaultMacro)(e.identifier,all(t,e).trim())}var all=require("../all");module.exports=notes;var defaultMacro=function(t,e){return"\\footnotetext["+t+"]{\\label{footnote:"+t+"} "+e+"}\n"};

},{"../all":238}],266:[function(require,module,exports){
"use strict";function notes(e,t){return(e.footnoteReference||defaultMacro)(t.identifier)}module.exports=notes;var defaultMacro=function(e){return"\\textsuperscript{\\ref{footnote:"+e+"}}"};

},{}],267:[function(require,module,exports){
"use strict";function heading(n,t){var r=t.depth,e=all(n,t),u=(n.headings||defaultHeadings)[t.depth];if("function"!=typeof u)throw new Error("Cannot compile heading of depth "+r+": not a function");return u(e)}var all=require("../all");module.exports=heading;var defaultHeadings=[function(n){return"\\part{"+n+"}\n"},function(n){return"\\chapter{"+n+"}\n"},function(n){return"\\section{"+n+"}\n"},function(n){return"\\subsection{"+n+"}\n"},function(n){return"\\subsubsection{"+n+"}\n"},function(n){return"\\paragraph{"+n+"}\n"},function(n){return"\\subparagaph{"+n+"}\n"}];

},{"../all":238}],268:[function(require,module,exports){
"use strict";function html(t,e,u,l){return e.value}module.exports=html;

},{}],269:[function(require,module,exports){
"use strict";function image(e,a,i,n){var t=e.image||{},r=t.image?t.image:defaultMacro;return"paragraph"===n.type&&n.children.length-1&&(r=t.inlineImage?t.inlineImage:defaultInline),r(a)}module.exports=image;var defaultMacro=function(e){return"\\includegraphics"+(e.width?"[width="+e.width+"]":"")+"{"+e.url+"}"},defaultInline=defaultMacro;
...
},{"../escaper":249}],271:[function(require,module,exports){
...
},{"../all":238,"../escaper":249,"has":17}],272:[function(require,module,exports){
...
},{"../all":238}],273:[function(require,module,exports){
...
},{"../all":238,"has":17}],275:[function(require,module,exports){
...
},{"../all":238}],277:[function(require,module,exports){
...
},{"../one":251}],278:[function(require,module,exports){
...
},{"../all":238}],280:[function(require,module,exports){
...
},{"../one":251}],281:[function(require,module,exports){
...
},{"../escaper":249}],282:[function(require,module,exports){
...
},{"unist-util-visit":227}],286:[function(require,module,exports){
"use strict";var spaceSeparated=require("space-separated-tokens"),C_NEWLINE="\n",C_NEWPARAGRAPH="\n\n";module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=new RegExp("[^\\\\]?(->|<-)"),n=["->","<-"],t=this.Parser,r=t.prototype.blockTokenizers,l=t.prototype.blockMethods;r.align_blocks=function(t,r,l){var s=t.now(),a=i.exec(r);if(a&&0===a.index){var o=a[1];if(l)return!0;for(var c=0,g=[],h=[],d="",f=!0,p=0;f;){var v=r.indexOf(C_NEWLINE,c+1),u=-1!==v?r.slice(c,v):r.slice(c),k=u.length>2&&"\\"===u[u.length-3];if(g.push(u),!k&&(v>p+2||-1===v)&&u.length>=2&&-1!==n.indexOf(u.slice(-2))){if(""===d&&(d=u.slice(-2)),h.push(g.join(C_NEWLINE)),r.indexOf("->",v)!==v+1)break;g=[],p=v+1}c=v+1,f=-1!==v}if(0!==h.length){for(var E="",N=h[0].substring(h[0].length-2,h[0].length),A=[],b=0;b<h.length;++b){var x=h[b];if(N!==x.substring(x.length-2,x.length))break;A.push(x),E+=x.slice(2,-2)+C_NEWPARAGRAPH}var _=t(A.join(C_NEWLINE)),C=this.enterBlock(),P=this.tokenizeBlock(E,s);C();var W=void 0,R=void 0;return"<-"===o&&"<-"===d?(W="leftAligned",R=e.left?e.left:"align-left"):"->"===o&&"<-"===d?(W="centerAligned",R=e.center?e.center:"align-center"):"->"===o&&"->"===d&&(W="rightAligned",R=e.right?e.right:"align-right"),_({type:W,children:P,data:{hName:"div",hProperties:{class:spaceSeparated.parse(R)}}})}}},l.splice(l.indexOf("fencedCode")+1,0,"align_blocks")};

},{"space-separated-tokens":192}],287:[function(require,module,exports){
...
},{"clone":10,"unist-util-visit":227,"xtend":237}],288:[function(require,module,exports){
...
"use strict";function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var spaceSeparated=require("space-separated-tokens"),C_NEWLINE="\n",C_FENCE="|";module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},o=Object.keys(e).map(escapeRegExp).join("|");if(!o)throw new Error("remark-custom-blocks needs to be passed a configuration object as option");var t=new RegExp("\\[\\[("+o+")\\]\\]"),r=this.Parser,s=r.prototype.blockTokenizers,c=r.prototype.blockMethods;s.custom_blocks=function(o,r,s){var c=o.now(),i=t.exec(r);if(i&&0===i.index){if(s)return!0;for(var a=[],n=[],p=0;-1!==(p=r.indexOf(C_NEWLINE));){var d=r.indexOf(C_NEWLINE,p+1),l=-1!==d?r.slice(p+1,d):r.slice(p+1);if(l[0]!==C_FENCE)break;var u=l.slice(l.startsWith(C_FENCE+" ")?2:1);a.push(l),n.push(u),r=r.slice(p+1)}var E=n.join(C_NEWLINE),f=o(""+i[0]+C_NEWLINE+a.join(C_NEWLINE)),k=this.enterBlock(),C=this.tokenizeBlock(E,c);k();var N=e[i[1]],_=spaceSeparated.parse(N);return f({type:i[1]+"CustomBlock",children:C,data:{hName:"div",hProperties:{className:_}}})}},c.splice(c.indexOf("fencedCode")+1,0,"custom_blocks");var i=r.prototype.interruptParagraph,a=r.prototype.interruptList,n=r.prototype.interruptBlockquote;i.splice(i.indexOf("fencedCode")+1,0,["custom_blocks"]),a.splice(a.indexOf("fencedCode")+1,0,["custom_blocks"]),n.splice(n.indexOf("fencedCode")+1,0,["custom_blocks"])};

},{"space-separated-tokens":192}],290:[function(require,module,exports){
...
},{"unist-util-visit":227}],295:[function(require,module,exports){
...
},{"url":228}],297:[function(require,module,exports){
...
"use strict";function plugin(){return transformer}function transformer(o){footnotes={},visit(o,"footnote",normalize),visit(o,"footnoteDefinition",normalize),visit(o,"normalizedfootnote",visitor),visit(o,"normalizedfootnote",denormalize),visit(o,"footnoteReference",visitor)}function normalize(o,t,i){o.originalType=o.type,o.type="normalizedfootnote"}function denormalize(o,t,i){o.type=o.originalType,o.originalType=null}function visitor(o,t,i){var e=o.identifier||JSON.stringify(o.position.start);footnotes.hasOwnProperty(e)||(footnotes[e]=Object.keys(footnotes).length+1),o.identifier=footnotes[e]}var visit=require("unist-util-visit"),footnotes={};module.exports=plugin;
...
},{"unist-util-visit":227}],300:[function(require,module,exports){
...
},{"textr":197,"unist-util-visit":227}]},{},[318])(318)
});
