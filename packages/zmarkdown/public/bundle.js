...
"use strict";function notes(t,e){return(t.footnoteDefinition||defaultMacro)(e.identifier,all(t,e).trim())}var all=require("../all");module.exports=notes;var defaultMacro=function(t,e){return"\\footnotetext["+t+"]{\\label{"+t+"} "+e+"}\n"};

},{"../all":238}],266:[function(require,module,exports){
"use strict";function notes(e,t){return(e.footnoteReference||defaultMacro)(t.identifier)}module.exports=notes;var defaultMacro=function(e){return"\\textsuperscript{\\ref{"+e+"}}"};
