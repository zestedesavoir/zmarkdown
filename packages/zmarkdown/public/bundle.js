...
"use strict";function plugin(e){function n(n,r,t){var o=i.exec(r);if(o&&!(o.index>0)){var a=o[0],s=o[2]?o[2]:o[1];if(e.pingUsername(s)){var p=e.userURL(s);return n(a)({type:"ping",_metadata:s,url:p,children:[{type:"text",value:s}],data:{hName:"a",hProperties:{href:p,class:"ping"}}})}return n(a[0])({type:"text",value:a[0]})}}var r=this;if(!e.pingUsername||"function"!=typeof e.pingUsername)throw new Error("remark-ping: expected configuration to be passed: {\n  pingUsername: (username) => bool,\n  userURL: (username) => string\n}");if(!e.userURL||"function"!=typeof e.userURL)throw new Error("remark-ping: expected configuration to be passed: {\n  pingUsername: (username) => bool,\n  userURL: (username) => string\n}");var i=e.usernameRegex||/[\s'"(,:<]?@(?:\*\*([^*]+)\*\*|(\w+))/;n.locator=function(e,n){var r=i.exec(e,n);return r?e.indexOf("@",r.index):-1};var t=this.Parser,o=t.prototype.inlineTokenizers,a=t.prototype.inlineMethods;o.ping=n,a.splice(a.indexOf("text"),0,"ping");var s=this.Compiler;s&&(s.prototype.visitors.ping=function(e){return"@**"+r.all(e).join("")+"**"})}module.exports=plugin;
