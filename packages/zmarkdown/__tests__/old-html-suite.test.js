...
describe('#zds', () => {
  ...
  describe('#extensions', () => {
    ...
    it(`properly renders math.txt without custom config`, () => {
      ...
      expect((rendered.match(/katex-mathml/g) || []).length).toBe(4)
      expect((rendered.match(/span class="katex-display"/g) || []).length).toBe(1)
      expect((rendered.match(/inlineMath inlineMathDouble/g) || []).length).toBe(0)
      expect((rendered.match(/div class="math"/g) || []).length).toBe(1)
    })
    ...
    it(`properly renders math.txt`, () => {
      ...
      expect((rendered.match(/katex-mathml/g) || []).length).toBe(4)
      expect((rendered.match(/span class="katex-display"/g) || []).length).toBe(3)
      expect((rendered.match(/inlineMath inlineMathDouble/g) || []).length).toBe(2)
      expect((rendered.match(/div class="math"/g) || []).length).toBe(1)
    })
    ...
    it(`properly renders video_extra.txt`, () => {
      ...
      expect(renderFile(config)(filepath).trim()).toHTML(loadFixture(filepath).trim())
    })
